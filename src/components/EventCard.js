  ...
  <tr>
    <td className="deviceWidth" align="center" style={{ backgroundColor:"#ffffff,"}}>
      <table className="deviceWidth" cellSpacing="0" cellPadding="0" align="center" style={{width:"570px", margin:"0px auto",borderSpacing:"0",}}>
        <tbody>
        <tr>
          <td colSpan="2" style={{padding:"0px 0px 0px 0px", fontSize:"20px", fontWeight:"bold", verticalAlign:"top", fontFamily: "Roboto, Arial, sans-serif", textAlign:"left", color:"#333333", lineHeight:"26px",}}><a href={this.props.eturl+'?&utm_source=NMEvent01July2018&utm_medium=email&utm_campaign='+this.props.etutmcampaign+''} target="_blank" rel="noopener noreferrer" style={{textDecoration:"none", color:"#333333", fontFamily: "Roboto, Arial, sans-serif",}}>{this.props.etname}</a><span style={{display:"block",lineHeight:"18px", fontSize:"15px", padding:"5px 0 5px 0",fontWeight:"normal", color:"#666666",}}>{this.props.etvenues}</span><span style={{display:"block", padding:"5px 0 0px 0", lineHeight:"16px", fontSize:"12px",fontWeight:"normal", color:"#a3a3a3",}}>{this.props.etgenre}</span></td>
        </tr>
        <tr>
          ...
          <td valign="top" style={{minWidth:'108px',padding:'0px 0px 10px 0px', textAlign:"left"}}><a href={this.props.eturl+'?&utm_source=NMEvent01July2018&utm_medium=email&utm_campaign='+this.props.etutmcampaign+''} target="_blank" rel="noopener noreferrer" style={{textDecoration:"none", color:"#ffffff",}}><span style={{padding:"8px 24px 8px 24px", lineHeight:"40px", fontFamily: "Roboto, Arial, sans-serif", fontSize:"14px", whiteSpace:"nowrap", color:"#ffffff", backgroundColor:"#e7374d", fontWeight:"500", fontStyle:"normal", borderRadius:"5px",}}>Book&nbsp;Now</span></a></td>
        </tr>
        </tbody>
      </table>
    </td>
                                    ...
                                    <tr>
                                      <td style={{width:"100%"}}>
                                        <table cellPadding="0" cellSpacing="0" border="0" align="center" style={{backgroundColor:"#ffffff", margin:"0 auto"}}>
                                          ...
                                          <tr>
                                            <td style={{width:"100%",padding:"10px 5px 0px 5px", fontSize:"16px", verticalAlign:"top", fontFamily: "Roboto, Arial, sans-serif", textAlign:"left", color:"#333333", lineHeight:"22px"}}><a href={this.props.eturl+'?&utm_source=NMEvent01July2018&utm_medium=email&utm_campaign='+this.props.etutmcampaign+''} target="_blank" rel="noopener noreferrer" style={{textDecoration:"none", color:"#333333", fontFamily: "Roboto, Arial, sans-serif"}}>{this.props.etname}</a></td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td align="center" style={{width:"100%", padding:"5px 0px 0px 0px", backgroundColor:"#ffffff"}}>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style={{padding:"5px", textAlign:"right"}}><a href={this.props.eturl+'?&utm_source=NMEvent01July2018&utm_medium=email&utm_campaign='+this.props.etutmcampaign+''} target="_blank" rel="noopener noreferrer" style={{textDecoration:"none", color:"#ffffff"}}><span style={{padding:"8px 24px 8px 24px", lineHeight:"40px", fontFamily: "Roboto, Arial, sans-serif", fontSize:"14px", whiteSpace:"nowrap", color:"#ffffff", backgroundColor:"#e7374d", fontWeight:"500", fontStyle:"normal", borderRadius:"5px",}}>Book&nbsp;Now</span></a></td>
                                                </tr>
                                                </tbody>
                                              </table>
                                            </td>
