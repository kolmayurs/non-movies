	...
	return function(dispatch){
		...
		.then(res => {
			dispatch({type:'FETCH_DATA_SUCCESS', 
				...
				payload_etgenre0: res.data.BookMyShow.arrEventInfo[0].jsonGenre.GenreMeta[0],
		        payload_etgenre1: res.data.BookMyShow.arrEventInfo[0].jsonGenre.GenreMeta[1],
		        payload_etgenre2: res.data.BookMyShow.arrEventInfo[0].jsonGenre.GenreMeta[2],
